...
- (void)viewDidLoad {
    ...
    [_tableViewButton addTarget:self action:@selector(titleButtonClick:) forControlEvents:UIControlEventTouchUpInside];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.tableCellText.text = [NSString stringWithFormat:@"Project %li", indexPath.row];
    return cell;
}
